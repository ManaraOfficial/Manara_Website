          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl border-l-4 border-[#D34A32] border-y border-r border-gray-100 shadow-sm space-y-4">
              <div className="flex items-center gap-3 text-[#D34A32]">
                ...
                <h3 className="text-xl font-bold text-gray-900 font-['Montserrat',sans-serif]">{t("sponsorshipsDetail.shortTermGoalsTitle")}</h3>
              </div>
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl border-l-4 border-[#366A35] border-y border-r border-gray-100 shadow-sm space-y-4">
              <div className="flex items-center gap-3 text-[#366A35]">
                ...
                <h3 className="text-xl font-bold text-gray-900 font-['Montserrat',sans-serif]">{t("sponsorshipsDetail.longTermGoalsTitle")}</h3>
              </div>
              <ul className="space-y-3 text-gray-600 text-sm sm:text-base">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {howItWorksSteps.map((step, idx) => (
              <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center space-y-3" key={idx}>
                <div className={`w-12 h-12 rounded-full flex items-center justify-center mx-auto text-xl ${stepIconBg[idx]}`}>
                  {stepIcons[idx]}
                </div>
                <h3 className="font-bold text-lg text-gray-900 font-['Montserrat',sans-serif]">{step.title}</h3>
